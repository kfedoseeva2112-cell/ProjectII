...
# ------------------- ЗАГРУЗКА ФОТО (с key и отслеживанием изменения) -------------------
...
# --- ОБРАБОТКА СМЕНЫ ФАЙЛА ---
if uploaded_file is not None:
    current_name = uploaded_file.name
    # Если имя файла изменилось или это первый раз
    if st.session_state.last_uploaded_name != current_name:
        # Сбрасываем все данные, связанные с предыдущим анализом
        st.session_state.features = {}
        st.session_state.auto_detected = False
        st.session_state.recommendations = None
        st.session_state.features_full = {}
    ...
    # Если файл удалён, сбрасываем всё
...
# Значения по умолчанию – из распознанных (если есть) или стандартные
...
# ------------------- ВЫВОД РЕЗУЛЬТАТА (только если есть и загружен файл) -------------------
